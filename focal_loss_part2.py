...
def softmax_focal_loss(pred,
    ...
    weight_ = torch.ones(pred.size(0)).type_as(pred)
    loss = weight_reduce_loss(loss, weight_, reduction, avg_factor)
    return loss
...
class FocalLoss(nn.Module):
    ...
    def __init__(self,
        ...
        # assert use_sigmoid is True or isinstance(use_sigmoid, bool), \
